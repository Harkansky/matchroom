...
const RegisterPage = () => {
    return (
        <div className="px-4 mt-4 max-w-[800px] mx-auto">
            <div className="bg-[url(/img/register-illustration.jpg)] bg-[0%_70%] bg-cover w-full h-[250px] p-4 flex flex-col gap-8 mb-8 rounded-lg">
                <h2 className="uppercase text-white">
                    <Link to="/">Matchroom</Link>
                </h2>
            ...
            <form className="">
                <div className="flex gap-4">
                    <fieldset className="fieldset w-full">
                        <legend className="fieldset-legend text-gray-500 text-sm pb-1">Nom</legend>
                        <input
                            type="text"
                    ...
                    <fieldset className="fieldset w-full">
                        <legend className="fieldset-legend text-gray-500 text-sm pb-1">Prénom</legend>
                        <input type="text" className="input input-lg rounded-lg w-full text-[15px]" placeholder="Doe" />
                    </fieldset>
                </div>
                ...
                <div className="flex gap-4">
                    <fieldset className="fieldset w-full">
                        <legend className="fieldset-legend text-gray-500 text-sm pb-1">Date</legend>
                        <input
                            type="date"
                            className="input input-lg rounded-lg w-full text-[15px]"
                ...
                <fieldset className="fieldset w-full">
                    <legend className="fieldset-legend text-gray-500 text-sm pb-1">Téléphone</legend>
                ...
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-gray-500 text-sm pb-1">Confirmation du mot de passe</legend>
                    <input
                        type="password"
                        className="input input-lg rounded-lg w-full text-[15px]"
                        placeholder="Mot de passe"
