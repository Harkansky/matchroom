  ...
  return (
    ...
    <img src="/img/hotelRoom1.jpg" alt="hotel room" className='w-full rounded-b-4xl shadow-md/30' />
      ...
      <div className='flex flex-nowrap justify-center items-center gap-3 text-[10.51px]'>
        <img src="/img/Vector.png" alt="!" className='object-contain w-3 mb-1'/>
        <h3 className='font-light'>3 places de la vilette, 75160</h3>
      </div>
      <h3 className='font-light text-center text-[10.51px] mb-3'>Chambre double  - 2 lits - 1 douche - all inclusives</h3>
      ...
      <div className='flex flex-nowrap overflow-x-scroll scroll-smooth ml-3 mt-4'
      style={{
        scrollbarWidth: 'none',
        msOverflowStyle: 'none',
      }}>
        {dataImg.map((img) => (
          <img key={img.id} src="/img/hotelRoom1.jpg" alt={img.alt} className="rounded-lg shadow-lg w-[133px] h-[105px] object-cover mx-3" />
        ))}
      </div>

      <div className='ml-[5%] font-bold text-[12.75px] mt-6'>Equipements proposé</div>
      ...
      <div className='text-[#7F3A65] w-[90%] m-auto text-center text-[11px] border border-[#7F3A65] rounded-xl h-[32.174560546875] py-2 font-semibold'>Voir tout les équipements...</div>
      ...
      <div className='w-full h-[6%] max-h-[7rem] sticky bottom-0 flex flex-nowrap items-center justify-center gap-2 bg-white'
        style={{
        ...
        <div className='flex flex-col items-center justify-center w-[40%]'>
          ...
          <div className='text-[8.48px]'> 
            8 - 13 mai
          </div>
        </div>
        <button className='w-[60%] text-[11px] bg-amber-700 h-8 rounded-lg mr-5 text-white font-semibold'
        style={{
