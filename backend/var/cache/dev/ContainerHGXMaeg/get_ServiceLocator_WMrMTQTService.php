 ...
 */
class get_ServiceLocator_WMrMTQTService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.wMrMTQT' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    public static function do($container, $lazyLoad = true)
    {
        return $container->privates['.service_locator.wMrMTQT'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Controller\\Api\\UserController::list' => ['privates', '.service_locator._8VsPQl.App\\Controller\\Api\\UserController::list()', 'getUserControllerlistService', true],
            'kernel:registerContainerConfiguration' => ['privates', '.service_locator.zHyJIs5.kernel::registerContainerConfiguration()', 'get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService', true],
            'kernel:loadRoutes' => ['privates', '.service_locator.zHyJIs5.kernel::loadRoutes()', 'get_ServiceLocator_ZHyJIs5_KernelloadRoutesService', true],
            'App\\Controller\\Api\\UserController:list' => ['privates', '.service_locator._8VsPQl.App\\Controller\\Api\\UserController::list()', 'getUserControllerlistService', true],
        ], [
            ...
            'App\\Controller\\Api\\UserController::list' => '?',
            'kernel:registerContainerConfiguration' => '?',
            'kernel:loadRoutes' => '?',
            'App\\Controller\\Api\\UserController:list' => '?',
        ]);
